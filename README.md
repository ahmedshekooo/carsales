...
1.  **Data:** Ensure `sales_data_sample.csv` is in the root directory.
2.  **Code:** Open `notebook.ipynb` using a Jupyter environment (like VS Code, JupyterLab, or Google Colab).
3.  **Dependencies:** The notebook requires standard Python libraries: `pandas`, `numpy`, and `matplotlib`.
